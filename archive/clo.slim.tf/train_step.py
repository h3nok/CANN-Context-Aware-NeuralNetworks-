...
from preprocessing import inception_preprocessing as inception_preprocessing
...
labels_to_name = {0: "Normal", 1: "Abnormal"}

file_pattern = 'cifar10_%s_*.tfrecord'

items_to_descriptions = {
    'image': 'A clolor fundus photo image of a patient.',
    'label': 'A label that is as such -- 0:Normal, 1:Abnormal'
}

# ================= TRAINING INFORMATION ==================
num_epochs = 100  # 设置小值尝试更快

batch_size = 8  # 根据GPU的内存大小
...
def run():
    ...
    with tf.Graph().as_default() as graph:
        ...
        def _propose_syllabus(local_graph, images, labels):
            ...
            images, labels = sf._propose_syllabus('mi', 0)
        ...
        # Define supervisor for running a managed session. Do not run the summary_op automatically or else it will
