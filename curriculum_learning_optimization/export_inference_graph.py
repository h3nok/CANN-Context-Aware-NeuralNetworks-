...
bazel build tensorflow_models/curriculum_learning_optimization/slim:export_inference_graph
bazel-bin/tensorflow_models/curriculum_learning_optimization/slim/export_inference_graph \
...
tf.app.flags.DEFINE_string(
    'model_name', 'inception_v2', 'The name of the architecture to save.')
