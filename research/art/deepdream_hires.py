...
tf.app.flags.DEFINE_string("model", "D:\\viNet\RnD\\artifacts\inception5h\\tensorflow_inception_graph.pb", "Model")
tf.app.flags.DEFINE_string("input", "D:\\viNet\\RnD\deepdream\\Images\\DSC00639.JPG", "Input Image (JPG)");
...
#tf.GraphDef.FromString(open(FLAGS.model,encoding='Latin-1').read())
